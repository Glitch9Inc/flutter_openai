...
import 'package:flutter_openai/src/services/interfaces/run_interface.dart';
import 'package:http/src/client.dart';

interface class RunService implements RunInterface {
  @override
  ...
  Future<Run?> retrieve(String threadId, String runId) async {
    ...
    var resultRun =
        await OpenAIRequester.retrieve(formattedEndpoint, (p0) => Run.fromMap(p0), isBeta: true);
    OpenAILogger.logRunStatus(resultRun.status);
  ...
  Future<Run?> cancel(String threadId, String runId) {
    ...
    return OpenAIRequester.cancel(formattedEndpoint, (p0) => Run.fromMap(p0), isBeta: true);
  }
}
