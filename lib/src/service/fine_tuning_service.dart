...
@immutable
@protected
interface class FineTuningService implements EndpointInterface {
  @override
  ...
  Future<OpenAIFineTuneModel> create({
    ...
    return await OpenAIClient.post(
      body: {
        ...
        if (computeClassificationMetrics != null) "compute_classification_metrics": computeClassificationMetrics,
        if (classificationNClass != null) "classification_n_class": classificationNClass,
        if (classificationPositiveClass != null) "classification_positive_class": classificationPositiveClass,
  ...
  /// The stream will emit an [OpenAIRequestException] if the fine-tune job is terminated with an error.
  ///
  ///
