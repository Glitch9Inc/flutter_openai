...
final class AudioObject {
  ...
  /// This is used  to convert a [Map<String, dynamic>] object to a [AudioObject] object.
  factory AudioObject.fromMap(Map<String, dynamic> json) {
    return AudioObject(
      text: json['text'],
      task: json['task'],
      ...
      words:
          json['words'] != null ? List<Word>.from(json['words'].map((x) => Word.fromMap(x))) : null,
  ...
  ///  This method used to convert the [AudioObject] to a [Map<String, dynamic>] object.
  ///
...
final class Word {
  ...
  bool operator ==(Object other) {
    ...
    return other is Word && other.word == word && other.start == start && other.end == end;
  }
}
