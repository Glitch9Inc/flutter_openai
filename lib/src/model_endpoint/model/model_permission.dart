...
final class ModelPermission {
  ...
  /// This method is used to convert a [Map<String, dynamic>] object to a [ModelPermission] object.
  factory ModelPermission.fromMap(Map<String, dynamic> json) {
  ...
  @override
  bool operator ==(covariant ModelPermission other) {
