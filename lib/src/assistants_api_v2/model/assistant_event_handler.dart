...
class AssistantEventHandler {
  ...
  final StreamController<Thread> _threadGetController =
      StreamController<Thread>.broadcast();

  final StreamController<void> _textCreatedController =
  ...
  final StreamController<Run> _runGetController =
      StreamController<Run>.broadcast();
  final StreamController<RunStep> _runStepGetController =
      StreamController<RunStep>.broadcast();
  final StreamController<Message> _messageCreatedController =
  ...
  final StreamController<void> _streamDoneController =
      StreamController<void>.broadcast();
  ...
  Stream<RunStatus> get onRunStatusChanged =>
      _runStatusChangedController.stream;
