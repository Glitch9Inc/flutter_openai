...
import 'package:flutter_openai/src/config/assistants_config.dart';
...
class AssistantOptions {
  ...
  AssistantOptions({
    ...
    this.initialDelayForRunStatusCheckSec =
        AssistantsConfig.initialDelayForRunStatusCheckSec,
    this.recurringRunStatusCheckIntervalSec =
        AssistantsConfig.recurringRunStatusCheckIntervalSec,
