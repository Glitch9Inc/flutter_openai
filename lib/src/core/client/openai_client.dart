...
import "../utils/streaming_http_client_default.dart"
    if (dart.library.js) 'package:flutter_openai/src/core/utils/streaming_http_client_web.dart'
    if (dart.library.io) 'package:flutter_openai/src/core/utils/streaming_http_client_io.dart';
