...
final class ImageData {
  ...
  /// This method is used to convert a [Map<String, dynamic>] object to a [ImageData] object.
  ...
  bool operator ==(covariant ImageData other) {
    ...
    return other.url == url && other.b64Json == b64Json && other.revisedPrompt == revisedPrompt;
  }
