...
import 'sub_models/fine_tuning_event.dart';
import 'sub_models/hyper_parameters.dart';
import 'sub_models/training_files.dart';

export 'stream/fine_tuning_event_chunk.dart';
export 'sub_models/fine_tuning_event.dart';
export 'sub_models/hyper_parameters.dart';
...
final class OpenAIFineTuneModel {
  ...
  final List<FineTuningEvent>? events;
  ...
  factory OpenAIFineTuneModel.fromMap(Map<String, dynamic> json) {
    return OpenAIFineTuneModel(
      ...
      events: (json['events'] as List?)?.map((e) => FineTuningEvent.fromMap(e)).toList(),
      fineTunedModel: json['fine_tuned_model'],
      hyperparams: HyperParameters.fromMap(json['hyperparams']),
      ...
      trainingFiles: (json['training_files'] as List).map((e) => TrainingFiles.fromMap(e)).toList(),
