...
final class TrainingFiles {
  ...
  /// {@macro openai_fine_tune_training_files_model}
  /// This method is used to convert a [Map<String, dynamic>] object to a [TrainingFiles] object.
  factory TrainingFiles.fromMap(Map<String, dynamic> json) {
  ...
  @override
  bool operator ==(covariant TrainingFiles other) {
