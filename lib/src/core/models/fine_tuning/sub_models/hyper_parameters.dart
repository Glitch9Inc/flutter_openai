...
final class HyperParameters {
  ...
  /// This method is used to convert a [Map<String, dynamic>] object to a [HyperParameters] object.
  /// {@endtemplate}
  factory HyperParameters.fromMap(Map<String, dynamic> json) {
  ...
  @override
  bool operator ==(covariant HyperParameters other) {
